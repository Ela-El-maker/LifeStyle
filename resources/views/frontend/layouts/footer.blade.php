@php
    ...
    $footerUsefullLinks = \App\Models\FooterUsefullLink::all();
    $footerContact = \App\Models\FooterContactInfo::all();
        ...
        <div class="row footer-widgets">
            <div class="col-md-12 col-lg-3 widget">
                <div class="text-box">
                    <figure class="footer-logo">
                        <img src="{{asset($generalSettings->footer_logo)}}" alt="">
                    </figure>
                    <p>{{$footerInfo->info}} </p>
            ...
            <div class="col-md-4 col-lg-2 offset-lg-1 widget">
                ...
                <ul class="nav-menu">
                    ...
                    @foreach ($footerUsefullLinks as $links)
            ...
            <div class="col-md-4 col-lg-3 widget">
                ...
                <ul class="nav-menu">
                    ...
                    @foreach ($footerHelpLink as $link)
            ...
            <div class="row">
                <div class="col-12">
                    <div class="copyright">
                        ...
                        <p>{{$footerInfo->powered_by}} &nbsp; | &nbsp; 2024-2025</p>
                    </div>
                </div>
            </div>
        </div>
