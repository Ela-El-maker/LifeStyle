        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4>Update Feedback Section Setting</h4>
            </div>
            <div class="card-body">
            ...
            <form action="{{route('admin.feedback-section-setting.update',1)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row mb-4">
                  ...
                  <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                      <textarea name="sub_title" id="" cols="30" rows="10" class="form-control" style="height: 100px">{!! $feedbackTitle-> sub_title !!}</textarea>
                    </div>
                  </div>
